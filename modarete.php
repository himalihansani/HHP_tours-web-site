...
<select name="meal_type"  placeholder="Meal Type" value="<?php echo $row['meal_type'];?>" >
    <option <?php if($row['meal_type'] == 'BB (Bread &amp; Breakfast)'){ echo(' selected '); } ?> value="BB (Bread &amp; Breakfast)">BB (Bread &amp; Breakfast)</option>
 <option <?php if($row['meal_type'] == 'HB (Half Board)'){ echo(' selected '); } ?> value="HB (Half Board)">HB (Half Board)</option>
 <option <?php if($row['meal_type'] == 'FB (Full Board)'){ echo(' selected '); } ?> value="FB (Full Board)">FB (Full Board)</option>
...
<option <?php if($row['hotel_type'] == 'Standard Guest Houses'){ echo(' selected '); } ?> value="Standard Guest Houses">Standard Guest Houses</option>
 <option <?php if($row['hotel_type'] == 'Standard Hotels'){ echo(' selected '); } ?> value="Standard Hotels">Standard Hotels</option>
 <option <?php if($row['hotel_type'] == 'Boutique & Villas'){ echo(' selected '); } ?> value="Boutique & Villas">Boutique & Villas</option>
<option <?php if($row['hotel_type'] == '3 Star Hotels'){ echo(' selected '); } ?> value="3 Star Hotels">3 Star Hotels</option>
 <option <?php if($row['hotel_type'] == '4 Star Hotels'){ echo(' selected '); } ?> value="4 Star Hotels">4 Star Hotels</option>
 <option <?php if($row['hotel_type'] == '5 Star Hotels'){ echo(' selected '); } ?> value="5 Star Hotels">5 Star Hotels</option>
...
<option <?php if($row['pkg'] == 'Pearl of Ceylon Tour Pkg (05 Days 04 Nights)'){ echo(' selected '); } ?> value="Pearl of Ceylon Tour Pkg (05 Days 04 Nights)">Pearl of Ceylon Tour Pkg (05 Days 04 Nights)</option>
 <option <?php if($row['pkg'] == 'Culture & Nature Tour Pkg (06 Days 05 Nights)'){ echo(' selected '); } ?> value="Culture & Nature Tour Pkg (06 Days 05 Nights)">Culture & Nature Tour Pkg (06 Days 05 Nights)</option>
 <option <?php if($row['pkg'] == 'Mini Tour Pkg (02 Days 01 Nights)'){ echo(' selected '); } ?> value="Mini Tour Pkg (02 Days 01 Nights)">Mini Tour Pkg (02 Days 01 Nights)</option>
<!-- 
...
<textarea name="msg_sp" placeholder="Special Notes / Special Requests" style="width: 100%"><?php echo htmlspecialchars($row['msg_sp']); ?></textarea>
 <div class="btn-group">
		<center><input type="submit" value="UPDATE" name="EDIT" size="10"></center> &nbsp&nbsp <center><input type="submit" value="DELETE" name="DELETE" size="10"></center>
